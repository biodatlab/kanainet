"""
Inference script for evaluating KAN-ACNet on external validation dataset
...
Uses external validation data from ./data_seen
"""
...
DEFAULT_CHECKPOINTS_DIR = '/home/badboy-005/Desktop/uab-projects/KAN_models/checkpoints/ablation_threshold_miccai'
...
def get_external_validation_datasets(data_root='./data_seen'):
    """
...
def main():
    parser = argparse.ArgumentParser(description='Inference on external validation dataset with all KAN-ACNet configurations')
    ...
    parser.add_argument('--data_root', type=str, default=DEFAULT_DATA_ROOT,
                        help='Root directory containing external validation datasets')
    ...
    if args.checkpoint and os.path.exists(args.checkpoint):
        ...
        if args.output is None:
            ...
            args.output = f'./external_validation_result/{checkpoint_name}_{config_name}_seen.json'
    ...
    print("\n" + "=" * 100)
    print("SUMMARY: External Validation Results for All Configurations")
    print("=" * 100)
    ...
    print(f"\nBest configuration on external validation: {best_config['config_name']}")
